    ...
    <div>
        ...
        <section className='text-richblack-5 pt-10 relative h-fit min-h-[618px] w-full bg-richblack-800 flex flex-col items-center justify-center gap-4'>
            ...
            <div className='text-center text-4xl font-semibold mt-7'>
             ...
             <div className='mt-4 w-[60%] mx-auto text-center text-lg font-semibold text-richblack-300 mb-36 '>CodingEra is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</div>
